---
name: bidding-terminology
description: |
  나라장터 복수예가입찰 모든 용어와 개념 정의. 사정률, 기초대비사정률, 기초대비투찰률, 예가대비투찰률의
  정확한 정의와 계산법. AI 분석 방법론 (기초대비투찰률 vs 예가대비투찰률). 복수예가 무작위성(15C4=1,365),
  사정률 저장 형식(100+실제값), 낙찰하한가 동적 특성. 혼동 금지를 위한 영구 기록.
  Use when ANY confusion about bidding terminology, rate calculations, or analysis methodology occurs.
